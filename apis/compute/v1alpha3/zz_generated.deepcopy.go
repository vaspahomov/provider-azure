...
func (in *AKSAgentPoolParameters) DeepCopyInto(out *AKSAgentPoolParameters) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AKSAgentPoolParameters.
func (in *AKSAgentPoolParameters) DeepCopy() *AKSAgentPoolParameters {
	if in == nil {
		return nil
	}
	out := new(AKSAgentPoolParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *AKSClusterParameters) DeepCopyInto(out *AKSClusterParameters) {
	*out = *in
	...
	if in.AgentPools != nil {
		...
		*out = make([]*AKSAgentPoolParameters, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(AKSAgentPoolParameters)
