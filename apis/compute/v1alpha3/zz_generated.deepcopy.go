...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RegistryProperties) DeepCopyInto(out *RegistryProperties) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RegistryProperties.
func (in *RegistryProperties) DeepCopy() *RegistryProperties {
	if in == nil {
		return nil
	}
	out := new(RegistryProperties)
	in.DeepCopyInto(out)
	return out
}
