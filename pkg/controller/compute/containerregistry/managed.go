...
const (
	...
	errUpdateRegistryNotSupported = "update Registry not supported"
)
...
func (c *connecter) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	cl.Authorizer = auth
	return &external{client: cl, newPasswordFn: password.Generate}, nil
}
...
func (e *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	compute.UpdateRegistry(cr, &az)
	upToDate := compute.RegistryUpToDate(cr, &az)
	if compute.RegistryInitialized(cr) {
...
func (e *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	_, err := e.client.Create(ctx, cr.Spec.ResourceGroupName, meta.GetExternalName(cr), compute.NewRegistry(cr.Spec))
	if err != nil {
...
func (e *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	return managed.ExternalUpdate{}, errors.New(errUpdateRegistryNotSupported)
}
